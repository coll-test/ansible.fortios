...
try:
    from ansible_collections.ansible.fortios.plugins.modules import fortios_switch_controller_virtual_port_pool
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.fortios.plugins.modules.fortios_switch_controller_virtual_port_pool.Connection')
