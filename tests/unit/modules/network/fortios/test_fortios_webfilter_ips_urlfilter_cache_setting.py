...
try:
    from ansible_collections.ansible.fortios.plugins.modules import fortios_webfilter_ips_urlfilter_cache_setting
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.fortios.plugins.modules.fortios_webfilter_ips_urlfilter_cache_setting.Connection')
