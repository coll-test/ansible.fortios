...
try:
    from ansible_collections.ansible.fortios.plugins.modules import fortios_firewall_profile_protocol_options
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.fortios.plugins.modules.fortios_firewall_profile_protocol_options.Connection')
