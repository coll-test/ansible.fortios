...
try:
    from ansible_collections.ansible.fortios.plugins.modules import fortios_ssh_filter_profile
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.fortios.plugins.modules.fortios_ssh_filter_profile.Connection')
