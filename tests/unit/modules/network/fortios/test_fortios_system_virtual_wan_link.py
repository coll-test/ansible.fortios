...
try:
    from ansible_collections.ansible.fortios.plugins.modules import fortios_system_virtual_wan_link
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.fortios.plugins.modules.fortios_system_virtual_wan_link.Connection')
