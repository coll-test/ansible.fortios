...
try:
    from ansible_collections.ansible.fortios.plugins.modules import fortios_log_fortiguard_setting
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.fortios.plugins.modules.fortios_log_fortiguard_setting.Connection')
