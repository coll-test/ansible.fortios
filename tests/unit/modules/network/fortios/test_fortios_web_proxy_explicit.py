...
try:
    from ansible_collections.ansible.fortios.plugins.modules import fortios_web_proxy_explicit
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.fortios.plugins.modules.fortios_web_proxy_explicit.Connection')
