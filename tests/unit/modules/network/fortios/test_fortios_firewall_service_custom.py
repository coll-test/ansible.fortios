...
try:
    from ansible_collections.ansible.fortios.plugins.modules import fortios_firewall_service_custom
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.fortios.plugins.modules.fortios_firewall_service_custom.Connection')
