...
try:
    from ansible_collections.ansible.fortios.plugins.modules import fortios_wanopt_content_delivery_network_rule
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.fortios.plugins.modules.fortios_wanopt_content_delivery_network_rule.Connection')
