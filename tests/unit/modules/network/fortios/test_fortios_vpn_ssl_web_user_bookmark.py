...
try:
    from ansible_collections.ansible.fortios.plugins.modules import fortios_vpn_ssl_web_user_bookmark
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.fortios.plugins.modules.fortios_vpn_ssl_web_user_bookmark.Connection')
