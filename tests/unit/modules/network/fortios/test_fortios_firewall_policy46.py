...
try:
    from ansible_collections.ansible.fortios.plugins.modules import fortios_firewall_policy46
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.ansible.fortios.plugins.modules.fortios_firewall_policy46.Connection')
